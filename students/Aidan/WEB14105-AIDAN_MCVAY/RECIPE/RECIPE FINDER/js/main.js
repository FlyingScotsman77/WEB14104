console.log("main.js is blue da ba dee da ba die");
...
function searchForRecipes() {
    // here goes the code for the function
    
    // create a variable
    // select the input with jQuery
    // use the .val() function to get the input
    var searchInput = $("input[type='text']").val();
    console.log(searchInput);
    
    // used for searching for recipes via the API
    // pass in the value the typed in
    // once returned, run the display recipes function
